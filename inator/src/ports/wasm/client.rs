...
impl WasmClient {
    ...
    pub fn start_listening_server(&mut self){
    ...
    pub fn send_message<T: MessageTrait + Serialize + DeserializeOwned>(&mut self, message: &T){
        let mut buf = Vec::new();
    ...
    pub(crate) fn send_message_queued(&mut self) {
